...
<!--                        </div>-->
                        <div class="input-group" id="searchContainer" style="position: relative;top: 20px;">
                        ...
                        $query = "select id,title,content,DATE_FORMAT(article_date, '%M %d, %Y') as dr from article order by dr limit $start, $display";
                        $result = @mysqli_query($dbc, $query);
                        if($result){
                        ...
                        if($pages > 1)
                        {
                            ...
                            {
                                echo '<li><a href="article.php?start=' . ($start - $display) . '&page_num=' . $pages . '">&laquo;</a></li>';
                            }
                            if($current_page <= 3)
                                $page_start = 1;
                            ...
                            {
                                echo '<li><a href="article.php?start=' . ($start + $display) . '&page_num=' . $pages . '">&raquo;</a></li>';
                            }
                            echo '</ul>';
                        }
                        ?>
